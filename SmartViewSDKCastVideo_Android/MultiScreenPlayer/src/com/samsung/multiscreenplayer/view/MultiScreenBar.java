...
/**
 * Multi-screen bar that displays cast button, currently played movie title and play status
 * 
...
public class MultiScreenBar extends RelativeLayout {
	...
	private void initView(Context context) {
		mMainLayout = (RelativeLayout) inflate(context, R.layout.multiscreen_bar_layout, this);
	...
	public void setTitle(String title) {
		final TextView videoTitle = (TextView) mMainLayout.findViewById(R.id.video_title);
