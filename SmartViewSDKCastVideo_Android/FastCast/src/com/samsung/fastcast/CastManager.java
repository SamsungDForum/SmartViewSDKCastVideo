...
public class CastManager extends StateMachine<CastStates> {
	 ...
	 */
	private Result<Client> mConnectResult = new Result<Client>() {

		@Override
		public void onError(Error error) {
			if (error.getCode() == 404) { // application is not installed
				// Try install scenario doesn't work due to probably buggy msf!
	 ...
	 * check in MSF?).
	 */
	private Result<Client> mDisconnectResult = new Result<Client>() {
